...
function Login({ setStorage }: LoginProps) {
	...
	const login_link = 'https://api.intra.42.fr/oauth/authorize?client_id=' + process.env.REACT_APP_UID42 + '&redirect_uri=http%3A%2F%2F' + process.env.REACT_APP_POSTURL + ':3000%2Fpage1&response_type=code';
