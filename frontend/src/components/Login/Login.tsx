...
function Login() {
	...
	const handleClick = () => {
		window.location.href = 'https://api.intra.42.fr/oauth/authorize?client_id=u-s4t2ud-f39a59f82957bad0642f4be1faea5067291f39a0db633432ee499d5c0753b2c2&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fpage1&response_type=code';
	};
	...
	return (
		<div className='login'>
			...
			<div className="loginPage">
				...
				{/*<a href="/test" className="login42">42 Auth</a>*/}
				<button onClick={handleClick}>Login with 42</button>
			</div>
		</div>
	);
}
