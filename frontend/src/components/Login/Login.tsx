...
function Login() {
	...
	const login_link = 'https://api.intra.42.fr/oauth/authorize?client_id=' + process.env.REACT_APP_UID42 + '&redirect_uri=http%3A%2F%2Flocalhost%3A3000%2Fpage1&response_type=code';
